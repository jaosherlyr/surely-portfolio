...
// simple helper (instead of filter/join everywhere)
const cx = (...classes) => classes.filter(Boolean).join(' ');

export default function NavLinks({ onClick, type = 'header' }) {
  ...
  return (
    <div className={type === 'sidebar' ? styles.sidebar : styles.header}>
      <NavLink
        to="/"
        end
        className={({ isActive }) =>
